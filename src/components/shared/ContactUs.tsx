    ...
    <section className="bg-transparent py-12 px-6 lg:px-20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-gray-700 dark:text-gray-300">We would love to hear from you! Whether you have questions, feedback, or just want to get in touch, fill out the form below and we will get back to you soon.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 p-8 shadow-lg rounded-lg">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">Feel free to reach out to us through the following contact details or visit us at our office location.</p>
